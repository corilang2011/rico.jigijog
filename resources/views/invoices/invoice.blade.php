  ...
  Issued to:
          ...
          <div id="mid" class="mid-width">
            <div class="info">
              ...
              <h2 style="font-size: 1.0em;color:#5f6368;font-weight:300;">
              <a href="mailto:{{ $email }}" title="{{ $email }}" style="text-decoration: none;" > {{ $email }}</a></h2>
              <p></p>
            </div>
          </div>
    ...
    @endphp 
      ...
      <div class="row" style="text-align:right;display: inline-block;margin-right: 0px;">
        <img src="{{ url('/public') . '/' . $shop->logo }}" height="20" alt="{{ $shop->name }}" style="display:inline-block;">  
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
          <div id="mid" class="vertical" style="border-bottom: 0px dashed #ccc;">
            <div id="" style="text-align:center;width:800px;padding-top:10px;font-size: 1.2em;">
              ...
              <a href="{{url('/').'/support-ticket'}}" class="support-ticket" style="text-decoration: none;" title="Need help? 24/7 submit a ticket: {{url('/').'/support-ticket'}}" target="_blank" data-toggle="tooltip" data-original-title="support-ticket">
