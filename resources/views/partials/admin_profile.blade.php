            ...
            <form class="form-horizontal" action="{{ route('profile.update', Auth::user()->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                            ...
                            <label class="col-sm-2 control-label" for="name">{{__('Photo')}}</label>
                        
                         <div class="col-sm-10">
                            <input type="file" name="photo" id="file-000100" class="custom-input-file custom-input-file--4" data-multiple-caption="{count} files selected" accept="image/*" />
