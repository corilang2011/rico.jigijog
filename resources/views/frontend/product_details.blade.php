                        ...
                        <div class="product-description-wrapper">
                            ...
                            <form id="option-choice-form">
                                        ...
                                        <ul class="list-inline checkbox-alphanumeric checkbox-alphanumeric--style-1 mb-2">
                                            @foreach ($choice->options as $key => $option)
                                                <li>
                                                    ...
                                                    <label class="v_active" for="{{ $choice->name }}-{{ $option }}">{{ $option }}</label>
                                                </li>
                                            @endforeach
                                        </ul>
                                    </div>
                                ...
                                @php                                                                    
                                    ...
                                    {                                        
                                        $qty_value = 1;                                        
                                        $i_classbtn = 'la la-plus';                                        
                                        $btn_addtocart_link = 'addToCart()';                                        
                                        $style_cbtn = '';                                       
                                        $disable_btn = '';                                                                            
                                    }else{                                        
                                        $qty_value = 0;                                        
                                    ...
                                    <div class="col-10">
                                        <div class="product-quantity d-flex align-items-center">
                                            <div class="input-group input-group--style-2 pr-3" style="width: 160px;">
                                                ...
                                                <input type="text" name="quantity" class="form-control input-number text-center" placeholder="1" value="{{$qty_value}}" min="1" max="{{$qty}}">
                                                <span class="input-group-btn">
                            ...
                            <div class="d-table width-100 mt-3">
                                <div class="d-table-cell">
                                    ...
                                    @if(count(json_decode($product->variations, true)) >= 1)
                                        @if ($qty > 0)  
                                            <!--
                                            <button type="button" class="btn btn-styled btn-base-1 btn-icon-left strong-700 hov-bounce hov-shaddow" onclick="buyNow()" style="background: #ccc;" disabled>
                                    ...
                                    @endif
                                    <!-- Add to cart button -->
                                    <button type="button" class="btn btn-styled btn-alt-base-1 c-white btn-icon-left strong-700 hov-bounce hov-shaddow ml-2" onclick="{{$btn_addtocart_link}}" style="{{$style_cbtn}};" {{$disable_btn}}>                                       
