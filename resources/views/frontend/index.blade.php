                                            ...
                                            <div class="p-3">
                                                ...
                                                <div class="clearfix">
                                                    ...
                                                    <div class="float-right">
                                                        <button class="add-to-cart btn" style="width: 60px; background-color: #FF4E00">
                                                            <p class="text-center text-white" style="margin-top: 3px;">{{ $product->num_of_sale }} Sold</p>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <section class="mb-5">
            <div class="container">
                <div class="p-4 bg-white shadow-sm">
                    ...
                    <div class="caorusel-box">
                        <div class="slick-carousel" data-slick-items="3" data-slick-lg-items="3"  data-slick-md-items="2" data-slick-sm-items="2" data-slick-xs-items="1" data-slick-dots="true" data-slick-rows="2">
                            @foreach (\App\Seller::where('paypal_status', 0)->limit(50)->inRandomOrder()->get() as $key => $seller)
                                @php
                                    $total = 0;
                                    $rating = 0;
                                ...
                                @endphp
                                @if($seller->user->products->sum('num_of_sale') > 1)
                                    <div class="p-2">
