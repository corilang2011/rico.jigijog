                            ...
                            <div class="col-md-3 col-6">
                                <div class="dashboard-widget text-center blue-widget mt-4 c-pointer">
                                    <a href="javascript:;" class="d-block">
                                        ...
                                        @endphp
                                        <span class="d-block title heading-3 strong-400">{{ single_price($product) }}</span>
                                        <span class="d-block sub-title">{{__('Product Total earnings')}}</span>
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
