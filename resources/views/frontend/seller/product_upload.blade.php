...
<title>JigiJog | Products - Upload</title>
@section('content')
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="meta_title" class="form-control mb-3" placeholder="{{__('Keyword_Meta Title')}}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Meta Product Image')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <!-- <div class="row">
                                        ...
                                        <div class="col-md-10"> -->
                                            <input type="number" min="0" value="0" step="0.01" class="form-control mb-3" name="purchase_price" placeholder="{{__('Purchase Price')}}" hidden>
                                        <!-- </div>
                                    </div> -->
                                    <div class="row">
                                        <div class="col-md-2">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control mb-3 weight" name="weight" placeholder="{{__('Weight')}}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="number" min="0.1" step="0.01" class="form-control mb-3 length" name="length" placeholder="{{__('Length')}}" required>
                                        </div>
                                        <div class="col-md-3">
                                            <input type="number" min="0.1" step="0.01" class="form-control mb-3 width" name="width" placeholder="{{__('Width')}}" required>
                                        </div>
                                        <div class="col-md-3">
                                            <input type="number" min="0.1" step="0.01" class="form-control mb-3 height" name="height" placeholder="{{__('Height')}}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                        <b>₱<span id="displayy">75</span></b>
                                            <label class="switch" style="margin-top:5px;">
                                                <input type="radio" name="shipping_type" value="flat_rate" checked>
                                                <span class="slider round"></span>
                                                <input id='sc' type="text" name="shipping_cost" value="" hidden>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row">
