...
<title>JigiJog | Products - Edit</title>
@section('content')
                        ...
                        <form class="" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                <select class="form-control mb-3 selectpicker" name="unit" data-live-search="true" placeholder="Product unit" required>
                                                <option value="{{ $product->unit }}" selected disabled>Product Unit</option>
                                                    <option value="Piece" <?php if($product->unit == 'Piece') echo "selected";?>>Piece</option>
                                                    <option value="Kilogram" <?php if($product->unit == 'Kilogram') echo "selected";?>>Kilogram</option>
                                                    <option value="Gram" <?php if($product->unit == 'Gram') echo "selected";?>>Gram</option>
                                                    <option value="Volume" <?php if($product->unit == 'Volume') echo "selected";?>>Volume</option>
                                                    <option value="Unit" <?php if($product->unit == 'Unit') echo "selected";?>>Unit</option>
                                                    <option value="Centimeter" <?php if($product->unit == 'Centimeter') echo "selected";?>>Centimeter</option>
                                                    <option value="Meter" <?php if($product->unit == 'Meter') echo "selected";?>>Meter</option>
                                                    <option value="Milliliter" <?php if($product->unit == 'Milliliter') echo "selected";?>>Milliliter</option>
                                                    <option value="Liter" <?php if($product->unit == 'Liter') echo "selected";?>>Liter</option>
                                                    <option value="Milligram" <?php if($product->unit == 'Milligram') echo "selected";?>>Milligram</option>
                                                    <option value="Pound" <?php if($product->unit == 'Pound') echo "selected";?>>Pound</option>
                                                    <option value="Set" <?php if($product->unit == 'Set') echo "selected";?>>Set</option>
                                                    <option value="Pair" <?php if($product->unit == 'Pair') echo "selected";?>>Pair</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Product Keyword')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div id="product-images">
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label>{{__('Product Main Images')}} <span class="required-star">*</span></label>
                                            </div>
                                            <div class="col-md-10">
                                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Product Thumbnail Image')}} <small>(290x300)</small> <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Product Featured Image')}} <small>(290x300)</small></label>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Product Flash Deal Image')}} <small>(290x300)</small></label>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="row">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Keyword/Meta Title')}}</label>
                                        </div>
                                        <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Meta Product Image')}}</label>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="row">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Manufacturers Price')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="purchase_price" placeholder="{{__('Manufacturers Price')}}" value="{{$product->purchase_price}}" required>
                                        </div>
                                    </div>
                                    @endif
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <input type="number" name="prev_price" value="{{$product->unit_price}}" hidden>
                                        </div>
                                    </div>
                                    <!-- <div class="row"> -->
                                        <!-- <div class="col-md-2">
                                        ...
                                        <div class="col-md-10"> -->
                                            <!--<input type="number" min="0" step="0.01" class="form-control mb-3" name="purchase_price" placeholder="{{__('Purchase Price')}}" value="{{$product->purchase_price}}" hidden>-->
                                        <!-- </div> -->
                                    <!-- </div> -->
                                    <div class="row">
                                        <div class="col-md-2">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{__('Weight (in kg)')}}</label>
                                        </div>
                                        <div class="col-md-8">
                                            <input type="number" step="0.001" value="{{ $product->weight }}" class="form-control mb-3 weight" name="weight" placeholder="{{__('Weight')}}" required>
                                        </div>
                                    </div>

                                    <div class="row">
                                        @php
                                            if($product->parcel_size != null){
                                                $arrLWH = explode(',', $product->parcel_size);
                                            }else{
                                                $arrLWH[0] = 0;
                                                $arrLWH[1] = 0;
                                                $arrLWH[2] = 0;
                                        ...
                                        @endphp
                                        <div class="col-md-2">
                                            <label>{{__('Parcel Size (in centimeters)')}}</label>
                                        </div>
                                        <div class="col-md-3">
                                            <input type="number" min="0.1" step="0.01" value="{{ $arrLWH[0] }}" class="form-control mb-3 length" name="length" placeholder="{{__('Length')}}" required>
                                        </div>
                                        <div class="col-md-3">
                                            <input type="number" min="0.1" step="0.01" value="{{ $arrLWH[1] }}" class="form-control mb-3 width" name="width" placeholder="{{__('Width')}}" required>
                                        </div>
                                        <div class="col-md-3">
                                            <input type="number" min="0.1" step="0.01" value="{{ $arrLWH[2] }}" class="form-control mb-3 height" name="height" placeholder="{{__('Height')}}" required> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <label style="font-weight:bold ;">Jigijog Express (min 0.1kg, max 5kg) <span style="background-color:#53a318; color:white; padding:7px;">JIGIJOG SUPPORTED COURIER</span></label>
                                        </div>
                                        <div class="col-md-2">
                                        <b>₱<span id="displayy">{{$product->shipping_cost}}</span></b>
                                            <label class="switch">
                                                <input type="radio" name="shipping_type" value="flat_rate" checked>
                                                <span class="slider round"></span>
                                                <input id='sc' type="text" name="shipping_cost" value="{{$product->shipping_cost}}" hidden>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <p style="opacity:0.5; font-size:0.9em;">Shipping settings will be applicable for this product only. Shipping fees displayed are base rates and will be subject to change depending on buyer location.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
