...
<title>JigiJog | Manage Profile - {{Auth::user()->name}}</title>
@section('content')
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" placeholder="Your Phone Number" name="phone" id="phone" value="{{ Auth::user()->phone }}">
                                        </div>
                                    </div>
                                    <!-- <div class="row">
                                        <div class="col-md-2">
