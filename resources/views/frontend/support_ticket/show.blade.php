                            ...
                            <div class="card-header py-3">
                                ...
                                <ul class="list-inline alpha-6 mb-0">
                                    ...
                                    @if($ticket->status == 'pending' || $ticket->status == 'open')
                                        <li class="list-inline-item"><span class="badge badge-pill badge-info">{{ $ticket->status }}</span></li>
                                    @elseif($ticket->status == 'solved')
                                        <li class="list-inline-item"><span class="badge badge-pill badge-success">Solved</span></li>
                                    @endif
                                </ul>
                            </div>
                            <div class="card-body">
                                <div class="border-bottom pb-4">
                                    @if($ticket->status != 'solved')
                                        <form class="" action="{{route('support-ticket.seller_store')}}" method="POST" enctype="multipart/form-data">
                                            @csrf
