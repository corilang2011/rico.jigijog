...
<title>Jigijog | Track Your Order</title>
@section('content')
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <table class="details-table table">
                                    ...
                                    <tr>
                                        <td class="w-50 strong-600">{{__('Shipping Fee')}}:</td>
                                        <td>{{  single_price( $order->orderDetails->where('order_id', $order->id)->sum('shipping_cost') ) }}</td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="col-6">
                                <table class="details-table table">
                                    @if($orderDetail->product != null)
                                        ...
                                        <tr>
                                            <td class="w-50 strong-600">{{__('Sold By')}}:</td>
