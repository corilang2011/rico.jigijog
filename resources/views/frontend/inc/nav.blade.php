<div class="header bg-white">
            ...
            <div class="row">
                ...
                <div class="col-5 text-right d-none d-lg-block">
                    <ul class="inline-links">
                        <li>
                            <a href="{{ route('shops.create') }}" class="top-bar-item">{{__('Seller Center')}}</a>
                        </li>
                        <li>
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle top-bar-item" data-toggle="dropdown">
                                @if(Auth::user()->avatar_original != null)
                                    <img src="{{ asset(''.Auth::user()->avatar_original) }}" class="rounded-circle" style="height:15px; width:15px;">&nbsp;<span class="language">{{ Auth::user()->name }}</span>
                                @else
                                    <img src="{{ asset('uploads/hop/logo/MtPSE0xOc3P1yPzhmmwgORqysdfeaklZlf0dneBA.jpeg') }}" class="rounded-circle" style="height:15px; width:15px;">&nbsp;<span class="language">{{ Auth::user()->name }}</span>
                                @endif
                            </a>
                            <ul class="dropdown-menu">
                        ...
                        @if (Auth::check() && Auth::user()->user_type == 'seller')
                            ...
                            <li>
                                <a href="{{ route('support-ticket.index') }}">
                                    ...
                                    <span class="category-name">{{__('Support Ticket')}}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('referrals.index') }}">
                                    <i class="la la-users"></i>
                                    <span class="category-name">{{__('Referral Program')}}</span>
                                </a>
                            </li>
                        @endif
    ...
    <div class="position-relative logo-bar-area mb--1" style="background-color: #ec9f05; background-image: linear-gradient(315deg, #ec9f05 0%, #ff4e00 74%);">
        <div class="">
            <div class="container">
                        ...
                        <div class="d-flex">
                            ...
                            <a class="navbar-brand w-100" href="{{ route('home') }}">
                                ...
                                @if($generalsetting->logo != null)
                                    <img src="{{ asset($generalsetting->logo) }}" class="" alt="Jigijog">
                                @else
                                    <img src="{{ asset('frontend/images/logo/logo.png') }}" class="" alt="Jigijog">
                                @endif
                            </a>
                                ...
                                <div class="d-none d-lg-inline-block">
                                    <div class="nav-compare-box" id="compare">
                                        <a href="{{ route('compare') }}" class="nav-box-link">
                                            ...
                                            <span class="nav-box-text d-none d-xl-inline-block text-white">{{__('Compare')}}</span>
                                            @if(Session::has('compare'))
                                ...
                                <div class="d-none d-lg-inline-block">
                                    <div class="nav-wishlist-box" id="wishlist">
                                        <a href="{{ route('wishlists.index') }}" class="nav-box-link">
                                            ...
                                            <span class="nav-box-text d-none d-xl-inline-block text-white">{{__('Wishlist')}}</span>
                                            @if(Auth::check())
                                ...
                                <div class="d-inline-block" data-hover="dropdown">
                                    <div class="nav-cart-box dropdown" id="cart_items">
                                        <a href="" class="nav-box-link" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <span class="nav-box-text d-none d-xl-inline-block text-white">{{__('Cart')}}</span>
                                            @if(Session::has('cart'))
    ...
    <div class="main-nav-area d-none d-lg-block " style="background-color: #ff4e00; background-image: linear-gradient(315deg, #ec9f05 0%, #ff4e00 74%);">
