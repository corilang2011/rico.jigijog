            ...
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                    ...
                    <div class="col">
                        <a href="{{ route('home') }}" class="d-block">
                            @if($generalsetting->logo != null)
                                <img src="{{ asset('frontend/images/logo/jigifooter.png') }}" class="" height="44">
                            @else
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="col text-center text-md-left">
                        ...
                        <ul class="footer-links inline-links">
                            <!--<li>-->
                            <!--    <img src="{{ asset('frontend/images/icons/cards/palawans.png')}}" height="50">-->
                            <!--</li>-->
                            <!--<li>-->
                            <!--    <img src="{{ asset('frontend/images/icons/cards/ml2.jpg')}}" height="50">-->
                            <!--</li>-->
                            <!--<br>-->
                            <!--<br>-->
                            <!--<li class="ml--1">-->
                            <!--    <img src="{{ asset('frontend/images/icons/cards/bpi.jpg')}}" height="55">-->
                            <!--</li>-->
                            <!--<li>-->
                            <!--    <img src="{{ asset('frontend/images/icons/cards/paymaya2.png')}}" height="55">-->
                            <!--</li>-->
                            <li>
                                <img src="{{ asset('frontend/images/icons/cards/cod.png')}}" height="55">
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4">
                    <div class="col text-center text-md-left">
                        ...
                        <ul class="footer-links inline-links">
                                <!--<li>-->
                                <!--    <img src="{{ asset('frontend/images/icons/cards/jrsexpress.png')}}" height="53">-->
                                <!--</li>-->
                                <li>
                                    <img src="{{ asset('frontend/images/icons/cards/jnt.jpg')}}" height="50">
                                </li>
                                <br>
                                <br>
                                <!--<li class="ml--1">-->
                                <!--    <img src="{{ asset('frontend/images/icons/cards/lbc.jpg')}}" height="53">-->
                                <!--</li>-->
                                <li class="ml--1">
                                    <img src="{{ asset('frontend/images/icons/cards/jigijogexpress.png')}}" height="50">
                                </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="text-center text-md-right">
                        <ul class="inline-links">
                            ...
                            @if (\App\BusinessSetting::where('type', 'stripe_payment')->first()->value == 1)
                                ...
                                <li>
                                    <img src="{{ asset('frontend/images/icons/cards/visa.png')}}" height="20">
                                </li>
                                <li>
                                    <img src="{{ asset('frontend/images/icons/cards/mastercard.png')}}" height="20">
                                </li>
                            @endif
