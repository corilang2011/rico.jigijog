        ...
        <div class="text-center">
            ...
            <form class="pad-hor" method="POST" role="form" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    @endif
                </div>				//-->								<div class="form-group">					<input id="email" type="text" class="form-control" name="email" value="{{ old('email') }}" required autofocus placeholder="Email or Phone">					@if ($errors->has('email'))                        <span class="invalid-feedback" role="alert">                            <strong>{{ $errors->first('email') }}</strong>                        </span>					@endif				</div>
                <div class="form-group">
