        ...
        <td>
          ...
          <td valign="top" style="width:100%" col="2">
            <table border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse;font-size:14px;color:#3d4452;width:100%"><tbody><tr><td style="font-size:14px;font-family:LucidaGrande,tahoma,verdana,arial,sans-serif;color:#3d4452;padding-bottom:6px; text-align: left;">
                ...
                @if($array['order_user_id'] != null) 

                    @php 
                    if($array['order_status'] == 'delivered'){ 

                            //$array['order_status'] = 'delivered'; 
                            $array['content'] = 'Your order has been successfully delivered and paid with the following details.';

                        } 
                        if($array['order_status'] == 'pending'){ 

                            //$array['order_status'] = 'pending'; 
                            $array['content'] = 'Your order has been pending.';
                ...
                @elseif($array['seller_id'] != null)

                @php 
                if($array['order_status'] == 'delivered'){ 

                        //$array['order_status'] = 'delivered'; 
                        $array['content'] = 'Your item has been delivered to your customer successfully with the  following details.';

                    } 
                    if($array['order_status'] == 'pending'){ 

                        //$array['order_status'] = 'pending'; 
                        $array['content'] = 'Your item has been pending.';
                    ...
                    if($array['order_status'] == 'on_delivery'){ 
                        ...
                        //$array['order_status'] = 'on_delivery';
                        $array['content'] = 'Your item is on delivery.'; 
                    ...
                    if($array['order_status'] == 'on_review'){ 
                        ...
                        //$array['order_status'] = 'on_review'; 
                        $array['content'] = 'Your item is being reviewed.';
                    ...
                    if($array['order_status'] == 'returned_item'){ 
                        ...
                        //$array['order_status'] = 'returned_item'; 
                        $array['content'] = 'Your item is being returned.';
                    ...
                    if($array['order_status'] == 'declined'){ 
                        ...
                        //$array['order_status'] = 'declined';
                        $array['content'] = 'Your item has been declined.';

                    }
                @endphp 

                  Hi {{ $array['seller_name'] }},
                </td></tr><tr><td style="font-size:14px;font-family:LucidaGrande,tahoma,verdana,arial,sans-serif;color:#3d4452;padding-top:6px;padding-bottom:6px; text-align: left;">
            ...
            &nbsp;</td>
                ...
                <tr>
                  ...
                  click here.</b></a>
                          ...
                          @else
                            @if($array['seller_id'] != null)
                            <!--nothing to display-->
                            @else
                            Thank you for shopping {{ $array['from_name'] }}.
                            @endif
                          @endif                 
